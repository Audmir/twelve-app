        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              ...
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table">Proprietaires</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table">Chauffeurs</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <?php
                      $query = $conn->prepare("SELECT * FROM proprietaire ORDER BY id DESC");
                      $query->execute();
                      $res = $query->fetchAll(PDO::FETCH_ASSOC);
                      if (count($res) > 0) {
                        foreach ($res as $row) {
                      ?>
                          <tbody>
                            <tr>
                              ...
                              <td><?php echo $row['proprietaire_id'] ?></td>
                              <td><a href="../../php/delete-proprietaire.php?id=<?php echo $row['id'] ?>"><button class="btn btn-primary">Supprimer</button></a></td>
                            </tr>
