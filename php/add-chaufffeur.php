...
$prop_id = htmlspecialchars($_POST['chauf_id']);
...
if (
    ...
    $query = $conn->prepare("INSERT INTO chauffeur(`chauffeur_id`,`nom_complet`,`data_de_naissance`,`Lieu_de_naissance`,`Adresse`,`Etat_civile`,`phone`,`email`,`photo`)
